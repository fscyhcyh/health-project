...
select * from t_checkitem where name like concat('%','身','%');
select distinct 'aaa' from t_checkitem;
...
select * from t_setmeal_checkgroup where setmeal_id=15;    
...
INSERT INTO `t_ordersetting` VALUES ('83', '2021-01-27', '300', '0');
INSERT INTO `t_ordersetting` VALUES ('84', '2021-01-28', '300', '0');
INSERT INTO `t_ordersetting` VALUES ('82', '2021-02-01', '2', '2');
...
INSERT INTO `t_member` VALUES ('85', null, 'a', null, '123456789101112', '13911223344', '2020-01-26', null, null, null, null);
...
select * from t_member where regTime < '2020.01.01';

 select count(id) from  t_member where regTime between '2020-01-01' and '2020-01-31';
...
INSERT INTO `t_order` VALUES ('9', '85', '2019-03-20', '微信预约', '未到诊', '6');
INSERT INTO `t_order` VALUES ('10', '86', '2019-03-28', '微信预约', '未到诊', '11');
...
select * from t_role_permission order by 1;
...
INSERT INTO `t_user` VALUES ('4', null, null, 'aa', '$2a$10$A2qa7hX3m4FNqPt9l2qGp./pUgJSMdu3lscW/bvg2Rv.ObAsmB2ma', null, null, null);
