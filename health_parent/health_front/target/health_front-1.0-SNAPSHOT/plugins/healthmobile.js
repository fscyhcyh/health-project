...
var num = 30;
var clock =null;
var validateCodeButton = null;
function doLoop(){
    validateCodeButton.disable = true;
    num--;
    if(num>0){
        validateCodeButton.value = "Re-generate in " + num;
    }else{
        clearInterval(clock);
        validateCodeButton.disable = false;
        validateCodeButton.value = "Re-generate Validation Code";
        num = 30;
    }
}